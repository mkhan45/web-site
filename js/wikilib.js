...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "js/wikilib.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "js/wikilib.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'wikilib'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'wikilib':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return Module.instance.exports.test();
}
;
                Module.exports.in_braces = function in_braces(content, index) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.in_braces(Module.STDWEB_PRIVATE.prepare_any_arg(content), Module.STDWEB_PRIVATE.prepare_any_arg(index)));
}
;
                Module.exports.parse_links = function parse_links(content) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.parse_links(Module.STDWEB_PRIVATE.prepare_any_arg(content)));
}
;
            __web_on_grow();
